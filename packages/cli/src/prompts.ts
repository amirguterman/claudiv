 ...
 */
export function requiresPrompts(specContent: string): boolean {
 ...
 */
export async function promptAIProvider(): Promise<PromptResponse> {
 ...
 */
export function formatProviderAttributes(promptResponse: PromptResponse, model: string): string {
